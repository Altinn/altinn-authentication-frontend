...
export interface ActionBarProps {
  ...
  /** The url to the logo image be displayed in the header of the ActionBar. */
  logoUrl?: string;
}
 ...
 * @property {string} [logoUrl] - The url to the logo image be displayed in the header of the ActionBar.
