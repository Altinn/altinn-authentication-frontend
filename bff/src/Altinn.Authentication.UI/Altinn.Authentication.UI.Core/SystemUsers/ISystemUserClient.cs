...
public interface ISystemUserClient
{
    ...
    Task<SystemUser?> PostNewSystemUserReal(string partyOrgNo, CreateSystemUserRequestToAuthComp newSystemUserDescriptor, CancellationToken cancellation = default);
